...
if ( isset( $_POST[ 'email' ] ) ) {
	...
	try {
		...
		$mail->Username = 'admin@migramus.de'; // SMTP username
		$mail->Password = 'Adm!n@M!gramus!8'; // SMTP password
		$mail->SMTPSecure = 'STARTTLS'; // Enable TLS encryption, `ssl` also accepted
		$mail->Port = 587; // TCP port to connect to

		//Recipients
		$mail->setFrom( 'admin@migramus.de', 'Admin' );
